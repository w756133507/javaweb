...
public class YouZanCustomerTest {
    ...
    public static void   updateRember() {
        try {
            ...
            List<YouzanScrmCardUpdateParams.YouzanScrmCardUpdateParamsRights> rightsList=new ArrayList<YouzanScrmCardUpdateParams.YouzanScrmCardUpdateParamsRights>();
    ...
    public static void   createRember() {
        try {
            ...
            List<YouzanScrmCardCreateParams.YouzanScrmCardCreateParamsRights> rightsList=new ArrayList<YouzanScrmCardCreateParams.YouzanScrmCardCreateParamsRights>();
